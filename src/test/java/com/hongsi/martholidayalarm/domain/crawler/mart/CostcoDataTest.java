...
public class CostcoDataTest {
	...
	public void parse() throws Exception {
		...
		String json = "{"
				...
				+ "\"storeContent\" : \"\\u003Ch3 class=\\u0027headline\\u0027\\u003E영업시간\\u003C\\/h3\\u003E\\u003Cp style=\\u0027font-size: 20px;\\u0027\\u003E오전 10:00 - 오후 10:00\\u003C\\/p\\u003E\\u003Cp style=\\u0027padding-top:10px;\\u0027\\u003E정부시책에 의거 유통산업 발전법에 따라 \\u003Cspan style=\\u0027color:red;\\u0027\\u003E매월 둘째, 넷째 일요일 의무 휴무\\u003C\\/span\\u003E합니다.\\u003Cbr \\/\\u003E*휴무일: 1\\/1, 설날, 추석 (전일은 오후 7시까지 영업)\\u003C\\/p\\u003E \\u003C\\/body\\u003E \\u003C\\/html\\u003E\", \"openings\": { \"일\":{\"individual\": \"오전 10:00 - 오후 10:00\" } , \"월\":{\"individual\": \"오전 10:00 - 오후 10:00\" } , \"화\":{\"individual\": \"오전 10:00 - 오후 10:00\" } , \"수\":{\"individual\": \"오전 10:00 - 오후 10:00\" } , \"목\":{\"individual\": \"오전 10:00 - 오후 10:00\" } , \"금\":{\"individual\": \"오전 10:00 - 오후 10:00\" } , \"토\":{\"individual\": \"오전 10:00 - 오후 10:00\" } }, \"features\" :[ \"서비스 델리\", \"휠체어 이용가능\", \"타이어 센터\", \"후레쉬 선어\", \"로티세리 치킨\", \"ATM\", \"푸드 코트\", \"후레쉬 정육\", \"후레쉬 델리\", \"후레쉬 청과야채\", \"후레쉬 베이커리\", \"특별 주문대 키오스크\" ], \"image\" : \"\\/medias\\/sys_master\\/images\\/h76\\/hd7\\/10276309139486.jpg\" }";

		costcoData = objectMapper.readValue(json, CostcoData.class);
		CrawlerMartData crawled = costcoData.toData();

		assertThat(crawled.getRealId()).isEqualTo("Daejeon");
		assertThat(crawled.getBranchName()).isEqualTo("대전점");
		assertThat(crawled.getRegion()).isEqualTo("대전");
		assertThat(crawled.getAddress()).isEqualTo("대전광역시 중구 오류로 41");
		assertThat(crawled.getPhoneNumber()).isEqualTo("+82-1899-9900");
		assertThat(crawled.getOpeningHours()).isEqualTo("오전 10:00 - 오후 10:00");
		assertThat(crawled.getHolidays().size()).isGreaterThan(0);
	}
	...
	@Test
	public void name() {
		System.out.println(LocalDate.of(2019, 1, 1).isBefore(LocalDate.of(2019, 12, 1)));
	}
}