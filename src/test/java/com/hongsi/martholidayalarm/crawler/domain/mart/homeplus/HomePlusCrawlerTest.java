package com.hongsi.martholidayalarm.crawler.domain.mart.homeplus;
...
public class HomePlusCrawlerTest extends MartCrawlerTest {
	...
	public void crawl() throws Exception {
		assertCrawledData(CrawlerMartType.HOMEPLUS,
				asList(MartType.HOMEPLUS, MartType.HOMEPLUS_EXPRESS));
	}
}