...
public class Message {
	...
	@ApiModelProperty(name = "이미지", value = "photo", dataType = "com.hongsi.martholidayalarm.service.dto.bot.kakao.Photo")
	private Photo photo;

	@ApiModelProperty(name = "링크 버튼", value = "message_button", dataType = "com.hongsi.martholidayalarm.service.dto.bot.kakao.MessageButton")
	...
	public Message(MartDto.Response mart) {
		text = makeBranchInfo(mart);
		messageButton = new MessageButton(mart);
	}

	private String makeBranchInfo(MartDto.Response mart) {
