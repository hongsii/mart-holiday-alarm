package com.hongsi.martholidayalarm.mobile.push.aspect;
...
public class PushLoggingAspect {
	...
	@Before("execution(* com.hongsi.martholidayalarm.mobile.push.PushScheduler.sendHolidayPushToUser())")
	public void start() {
		log.info("============ Start Push ============");
		stopWatch = new StopWatch("Push");
	}

	@After("execution(* com.hongsi.martholidayalarm.mobile.push.PushScheduler.sendHolidayPushToUser())")
	public void end() {
	...
	@Before("execution(* com.hongsi.martholidayalarm.mobile.push.service.*.*())"
			+ "|| execution(* com.hongsi.martholidayalarm.mart.service.MartService.findPushMartsByHoliday(*))")
